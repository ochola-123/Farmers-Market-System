...
if($category == 1)
{
    ...
    {
    	$sql = "INSERT INTO Farmer(Farmer_ID, Farmer_name ,Mobile_no, Email_ID, Ward, Password)
    			VALUES ('$user','$name','$mobile','$email','$ward','$password')";
...
else
{
    ...
    {
    	$sql = "INSERT INTO Customer(customer_ID,Customer_name,mobile_no,email_ID,ward,password)
    			VALUES ('$user','$name','$mobile','$email','$ward', '$password')";
